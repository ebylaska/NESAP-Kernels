...
//  psi1 = new double[npack1*ne];
//  psi2 = new double[npack1*ne];
//  matrix = new double[ne*ne];
...
//          for(int numtest=1;numtest<=1;++numtest)
          {
#ifdef OMP_TASK
...
//            }
        ...
        tstop=MPI_Wtime();
        cout<<"Time FFM: "<<tstop-tstart<<"s"<<endl;
